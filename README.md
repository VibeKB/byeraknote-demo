...
모바일 웹 버전 오답노트 앱입니다. 카메라 촬영 기능이 추가된 개선된 버전입니다.
...
- ✅ **카메라 촬영 기능**: 실시간 촬영 지원
- ✅ **MediaDevices API**: 모바일 카메라 접근
- ✅ **촬영/갤러리 선택**: 두 가지 입력 방식
- ✅ **고화질 이미지**: 원본 품질 유지
- ✅ **자동 저장**: 촬영 후 즉시 저장
- ✅ **PWA 지원**: 앱처럼 설치 가능
...
3. HTTPS 환경에서 카메라 기능 사용 가능

---

**벼락치기 오답노트**로 빠르고 효율적인 학습을 시작해보세요! ⚡📚 
